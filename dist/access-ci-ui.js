...
`;
var R, p, Ie, E, ae, xe, q, B = {}, ye = [], Ze = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, ie = Array.isArray;
function S(e, t) {
  for (var i in t)
    e[i] = t[i];
  return e;
...
function ce(e) {
  (!e.__d && (e.__d = !0) && E.push(e) && !H.__r++ || ae !== p.debounceRendering) && ((ae = p.debounceRendering) || xe)(H);
}
function H() {
...
function Ae(e, t, i, s, a, n, r, l, u, w, g) {
  ...
  for (i.__k = [], o = 0; o < y; o++)
    (d = i.__k[o] = (d = t[o]) == null || typeof d == "boolean" || typeof d == "function" ? null : typeof d == "string" || typeof d == "number" || typeof d == "bigint" ? O(null, d, null, null, d) : ie(d) ? O(b, { children: d }, null, null, null) : d.__b > 0 ? O(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d) != null && (d.__ = i, d.__b = i.__b + 1, (I = Ge(d, A, m = o + v, T)) === -1 ? f = B : (f = A[I] || B, A[I] = void 0, T--), oe(e, d, f, a, n, r, l, u, w, g), h = d.__e, (M = d.ref) && f.ref != M && (f.ref && ne(f.ref, null, d), g.push(M, d.__c || h, d)), h != null && (j == null && (j = h), N = !(L = f === B || f.__v === null) && I === m, L ? I == -1 && v-- : I !== m && (I === m + 1 ? (v++, N = !0) : I > m ? T > y - m ? (v += I - m, N = !0) : v-- : v = I < m && I == m - 1 ? I - m : 0), m = o + v, N = N || I == o && !L, typeof d.type != "function" || I === m && f.__k !== d.__k ? typeof d.type == "function" || N ? d.__d !== void 0 ? (u = d.__d, d.__d = void 0) : u = h.nextSibling : u = Ce(e, h, u) : u = Ne(d, u, e), typeof i.type == "function" && (i.__d = u)));
  for (i.__e = j, o = D; o--; )
      ...
      if (typeof y == "function") {
        if (m = t.props, I = (g = y.contextType) && s[g.__c], L = g ? I ? I.props.value : g.__ : s, i.__c ? j = (o = t.__c = i.__c).__ = o.__E : ("prototype" in y && y.prototype.render ? t.__c = o = new y(m, L) : (t.__c = o = new W(m, L), o.constructor = y, o.render = Re), I && I.sub(o), o.props = m, o.state || (o.state = {}), o.context = L, o.__n = s, M = o.__d = !0, o.__h = [], o._sb = []), o.__s == null && (o.__s = o.state), y.getDerivedStateFromProps != null && (o.__s == o.state && (o.__s = S({}, o.__s)), S(o.__s, y.getDerivedStateFromProps(m, o.__s))), f = o.props, d = o.state, o.__v = t, M)
          ...
          if (y.getDerivedStateFromProps == null && m !== f && o.componentWillReceiveProps != null && o.componentWillReceiveProps(m, L), !o.__e && (o.shouldComponentUpdate != null && o.shouldComponentUpdate(m, o.__s, L) === !1 || t.__v === i.__v)) {
            for (t.__v !== i.__v && (o.props = m, o.state = o.__s, o.__d = !1), t.__e = i.__e, t.__k = i.__k, t.__k.forEach(function(z) {
              z && (z.__ = t);
        ...
        if (o.context = L, o.props = m, o.__P = e, o.__e = !1, v = p.__r, A = 0, "prototype" in y && y.prototype.render) {
          for (o.state = o.__s, o.__d = !1, v && v(t), g = o.render(o.props, o.state, o.context), D = 0; D < o._sb.length; D++)
            o.__h.push(o._sb[D]);
          o._sb = [];
        } else
          do
...
const _e = "https://www.nsf.gov/awardsearch/showAward", P = ({
  number: e
}) => c("a", {
...
var Y, x, _, de, $ = 0, De = [], Z = [], pe = p.__b, ge = p.__r, he = p.diffed, Me = p.__c, fe = p.unmount;
function se(e, t) {
  p.__h && p.__h(x, e, $ || t), $ = 0;
