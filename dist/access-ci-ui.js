...
function ce(e) {
  (!e.__d && (e.__d = !0) && T.push(e) && !H.__r++ || ae !== p.debounceRendering) && ((ae = p.debounceRendering) || xe)(H);
}
function H() {
...
function Ae(e, t, i, s, a, n, r, l, u, w, g) {
  ...
  for (i.__k = [], o = 0; o < y; o++)
    (d = i.__k[o] = (d = t[o]) == null || typeof d == "boolean" || typeof d == "function" ? null : typeof d == "string" || typeof d == "number" || typeof d == "bigint" ? O(null, d, null, null, d) : ie(d) ? O(C, { children: d }, null, null, null) : d.__b > 0 ? O(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d) != null && (d.__ = i, d.__b = i.__b + 1, (I = Ge(d, A, m = o + v, D)) === -1 ? f = E : (f = A[I] || E, A[I] = void 0, D--), oe(e, d, f, a, n, r, l, u, w, g), h = d.__e, (M = d.ref) && f.ref != M && (f.ref && ne(f.ref, null, d), g.push(M, d.__c || h, d)), h != null && (b == null && (b = h), N = !(L = f === E || f.__v === null) && I === m, L ? I == -1 && v-- : I !== m && (I === m + 1 ? (v++, N = !0) : I > m ? D > y - m ? (v += I - m, N = !0) : v-- : v = I < m && I == m - 1 ? I - m : 0), m = o + v, N = N || I == o && !L, typeof d.type != "function" || I === m && f.__k !== d.__k ? typeof d.type == "function" || N ? d.__d !== void 0 ? (u = d.__d, d.__d = void 0) : u = h.nextSibling : u = Ce(e, h, u) : u = Ne(d, u, e), typeof i.type == "function" && (i.__d = u)));
  for (i.__e = b, o = S; o--; )
      ...
      if (typeof y == "function") {
        if (m = t.props, I = (g = y.contextType) && s[g.__c], L = g ? I ? I.props.value : g.__ : s, i.__c ? b = (o = t.__c = i.__c).__ = o.__E : ("prototype" in y && y.prototype.render ? t.__c = o = new y(m, L) : (t.__c = o = new W(m, L), o.constructor = y, o.render = Re), I && I.sub(o), o.props = m, o.state || (o.state = {}), o.context = L, o.__n = s, M = o.__d = !0, o.__h = [], o._sb = []), o.__s == null && (o.__s = o.state), y.getDerivedStateFromProps != null && (o.__s == o.state && (o.__s = j({}, o.__s)), j(o.__s, y.getDerivedStateFromProps(m, o.__s))), f = o.props, d = o.state, o.__v = t, M)
          ...
          if (y.getDerivedStateFromProps == null && m !== f && o.componentWillReceiveProps != null && o.componentWillReceiveProps(m, L), !o.__e && (o.shouldComponentUpdate != null && o.shouldComponentUpdate(m, o.__s, L) === !1 || t.__v === i.__v)) {
            for (t.__v !== i.__v && (o.props = m, o.state = o.__s, o.__d = !1), t.__e = i.__e, t.__k = i.__k, t.__k.forEach(function(U) {
              U && (U.__ = t);
...
function Je(e, t, i, s, a, n, r, l, u) {
  ...
  if (e == null) {
    ...
    e = a ? document.createElementNS("http://www.w3.org/2000/svg", d) : document.createElement(d, f.is && f), n = null, l = !1;
  }
  if (d === null)
    ...
    if (He(e, f, M, a, l), o)
      ...
      for (h = n.length; h--; )
        n[h] != null && Le(n[h]);
    l || ("value" in f && (h = f.value) !== void 0 && (h !== e.value || d === "progress" && !h || d === "option" && h !== M.value) && J(e, "value", h, M.value, !1), "checked" in f && (h = f.checked) !== void 0 && h !== e.checked && J(e, "checked", h, M.checked, !1));
  }
  return e;
}
function ne(e, t, i) {
...
const _e = "https://www.nsf.gov/awardsearch/showAward", V = ({
  number: e
}) => c("a", {
...
var P, x, _, de, $ = 0, De = [], Z = [], pe = p.__b, ge = p.__r, he = p.diffed, Me = p.__c, fe = p.unmount;
function se(e, t) {
  p.__h && p.__h(x, e, $ || t), $ = 0;
...
const te = (e = 900) => document.body.clientWidth >= e ? "desktop" : "mobile", ke = (e = 900) => {
  const [t, i] = K(te(e));
  return X(() => {
  ...
  Ke(e, i);
}, Ee = () => window.pageYOffset !== void 0 ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, at = ({
...
}), lt = `.container{box-sizing:content-box;height:84px;padding-top:20px}@media (min-width: 900px){.container{height:146px;padding-top:52px}}
`, rt = (e = {}) => c(C, {
  children: [c("div", {
    class: "container",
    children: c(Se, {
...
export {
  ...
  ht as header,
  ze as loginMenuItem,
  Ue as myAccessMenuItem,
  ft as siteMenus,
  mt as tableOfContents,
  Ye as universalMenuItems,
  Mt as universalMenus
};
