...
function Fe(e, t, i) {
  var s, c, n, r = {};
  for (n in t)
    n == "key" ? s = t[n] : n == "ref" ? c = t[n] : r[n] = t[n];
  if (arguments.length > 2 && (r.children = arguments.length > 3 ? H.call(arguments, 2) : i), typeof e == "function" && e.defaultProps != null)
    for (n in e.defaultProps)
      r[n] === void 0 && (r[n] = e.defaultProps[n]);
  return U(e, r, s, c, null);
}
function U(e, t, i, s, c) {
  var n = { type: e, props: t, key: i, ref: s, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: c ?? ++we };
  return c == null && p.vnode != null && p.vnode(n), n;
}
function C(e) {
  return e.children;
}
...
function Z(e, t) {
  if (t == null)
    return e.__ ? Z(e.__, e.__.__k.indexOf(e) + 1) : null;
...
function se(e) {
  (!e.__d && (e.__d = !0) && T.push(e) && !Q.__r++ || ne !== p.debounceRendering) && ((ne = p.debounceRendering) || me)(Q);
}
function Q() {
  var e, t, i, s, c, n, r, l, u;
  for (T.sort(X); e = T.shift(); )
    e.__d && (t = T.length, s = void 0, c = void 0, n = void 0, l = (r = (i = e).__v).__e, (u = i.__P) && (s = [], c = [], (n = j({}, r)).__v = r.__v + 1, te(u, r, n, i.__n, u.ownerSVGElement !== void 0, r.__h != null ? [l] : null, s, l ?? Z(r), r.__h, c), Ne(s, r, c), r.__e != l && ye(r)), T.length > t && T.sort(X));
  Q.__r = 0;
}
function Le(e, t, i, s, c, n, r, l, u, w, g) {
  var o, M, f, d, h, b, m, I, L, N, v = 0, A = s && s.__k || Ie, S = A.length, D = S, y = t.length;
  for (i.__k = [], o = 0; o < y; o++)
    (d = i.__k[o] = (d = t[o]) == null || typeof d == "boolean" || typeof d == "function" ? null : typeof d == "string" || typeof d == "number" || typeof d == "bigint" ? U(null, d, null, null, d) : ee(d) ? U(C, { children: d }, null, null, null) : d.__b > 0 ? U(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d) != null && (d.__ = i, d.__b = i.__b + 1, (I = Ze(d, A, m = o + v, D)) === -1 ? f = k : (f = A[I] || k, A[I] = void 0, D--), te(e, d, f, c, n, r, l, u, w, g), h = d.__e, (M = d.ref) && f.ref != M && (f.ref && ie(f.ref, null, d), g.push(M, d.__c || h, d)), h != null && (b == null && (b = h), N = !(L = f === k || f.__v === null) && I === m, L ? I == -1 && v-- : I !== m && (I === m + 1 ? (v++, N = !0) : I > m ? D > y - m ? (v += I - m, N = !0) : v-- : v = I < m && I == m - 1 ? I - m : 0), m = o + v, N = N || I == o && !L, typeof d.type != "function" || I === m && f.__k !== d.__k ? typeof d.type == "function" || N ? d.__d !== void 0 ? (u = d.__d, d.__d = void 0) : u = h.nextSibling : u = Ae(e, h, u) : u = ve(d, u, e), typeof i.type == "function" && (i.__d = u)));
  for (i.__e = b, o = S; o--; )
    A[o] != null && (typeof i.type == "function" && A[o].__e != null && A[o].__e == i.__d && (i.__d = A[o].__e.nextSibling), Ce(A[o], A[o]));
}
function ve(e, t, i) {
  for (var s, c = e.__k, n = 0; c && n < c.length; n++)
    (s = c[n]) && (s.__ = e, t = typeof s.type == "function" ? ve(s, t, i) : Ae(i, s.__e, t));
  return t;
}
function Ae(e, t, i) {
...
function Ze(e, t, i, s) {
  var c = e.key, n = e.type, r = i - 1, l = i + 1, u = t[i];
  if (u === null || u && c == u.key && n === u.type)
    return i;
  if (s > (u != null ? 1 : 0))
    for (; r >= 0 || l < t.length; ) {
      if (r >= 0) {
        if ((u = t[r]) && c == u.key && n === u.type)
          return r;
        r--;
      }
      if (l < t.length) {
        if ((u = t[l]) && c == u.key && n === u.type)
          return l;
        l++;
      }
    }
...
function Qe(e, t, i, s, c) {
  var n;
  for (n in i)
    n === "children" || n === "key" || n in t || G(e, n, null, i[n], s);
  for (n in t)
    c && typeof t[n] != "function" || n === "children" || n === "key" || n === "value" || n === "checked" || i[n] === t[n] || G(e, n, t[n], i[n], s);
}
function ce(e, t, i) {
  t[0] === "-" ? e.setProperty(t, i ?? "") : e[t] = i == null ? "" : typeof i != "number" || We.test(t) ? i : i + "px";
}
function G(e, t, i, s, c) {
  var n;
  e:
    if (t === "style")
      if (typeof i == "string")
        ...
        if (typeof s == "string" && (e.style.cssText = s = ""), s)
          for (t in s)
            i && t in i || ce(e.style, t, "");
        if (i)
          for (t in i)
            s && i[t] === s[t] || ce(e.style, t, i[t]);
      }
    else if (t[0] === "o" && t[1] === "n")
      n = t !== (t = t.replace(/Capture$/, "")), t = t.toLowerCase() in e ? t.toLowerCase().slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + n] = i, i ? s || e.addEventListener(t, n ? le : ae, n) : e.removeEventListener(t, n ? le : ae, n);
      ...
      typeof i == "function" || (i == null || i === !1 && t[4] !== "-" ? e.removeAttribute(t) : e.setAttribute(t, i));
    }
}
function ae(e) {
...
function te(e, t, i, s, c, n, r, l, u, w) {
  ...
  try {
    e:
      if (typeof y == "function") {
        if (m = t.props, I = (g = y.contextType) && s[g.__c], L = g ? I ? I.props.value : g.__ : s, i.__c ? b = (o = t.__c = i.__c).__ = o.__E : ("prototype" in y && y.prototype.render ? t.__c = o = new y(m, L) : (t.__c = o = new z(m, L), o.constructor = y, o.render = He), I && I.sub(o), o.props = m, o.state || (o.state = {}), o.context = L, o.__n = s, M = o.__d = !0, o.__h = [], o._sb = []), o.__s == null && (o.__s = o.state), y.getDerivedStateFromProps != null && (o.__s == o.state && (o.__s = j({}, o.__s)), j(o.__s, y.getDerivedStateFromProps(m, o.__s))), f = o.props, d = o.state, o.__v = t, M)
          ...
          if (y.getDerivedStateFromProps == null && m !== f && o.componentWillReceiveProps != null && o.componentWillReceiveProps(m, L), !o.__e && (o.shouldComponentUpdate != null && o.shouldComponentUpdate(m, o.__s, L) === !1 || t.__v === i.__v)) {
            for (t.__v !== i.__v && (o.props = m, o.state = o.__s, o.__d = !1), t.__e = i.__e, t.__k = i.__k, t.__k.forEach(function(Y) {
              Y && (Y.__ = t);
        ...
        if (o.context = L, o.props = m, o.__P = e, o.__e = !1, v = p.__r, A = 0, "prototype" in y && y.prototype.render) {
          for (o.state = o.__s, o.__d = !1, v && v(t), g = o.render(o.props, o.state, o.context), S = 0; S < o._sb.length; S++)
            o.__h.push(o._sb[S]);
          o._sb = [];
        } else
          do
            o.__d = !1, v && v(t), g = o.render(o.props, o.state, o.context), o.state = o.__s;
          while (o.__d && ++A < 25);
        o.state = o.__s, o.getChildContext != null && (s = j(j({}, s), o.getChildContext())), M || o.getSnapshotBeforeUpdate == null || (h = o.getSnapshotBeforeUpdate(f, d)), Le(e, ee(D = g != null && g.type === C && g.key == null ? g.props.children : g) ? D : [D], t, i, s, c, n, r, l, u, w), o.base = t.__e, t.__h = null, o.__h.length && r.push(o), b && (o.__E = o.__ = null);
      } else
        n == null && t.__v === i.__v ? (t.__k = i.__k, t.__e = i.__e) : t.__e = Ge(i.__e, t, i, s, c, n, r, u, w);
    (g = p.diffed) && g(t);
  } catch (Y) {
    t.__v = null, (u || n != null) && (t.__e = l, t.__h = !!u, n[n.indexOf(l)] = null), p.__e(Y, t, i);
  }
}
function Ne(e, t, i) {
  for (var s = 0; s < i.length; s++)
    ie(i[s], i[++s], i[++s]);
  p.__c && p.__c(t, e), e.some(function(c) {
    try {
      e = c.__h, c.__h = [], e.some(function(n) {
        n.call(c);
      });
    } catch (n) {
      p.__e(n, c.__v);
...
function Ge(e, t, i, s, c, n, r, l, u) {
  ...
  if (e == null) {
    ...
    e = c ? document.createElementNS("http://www.w3.org/2000/svg", d) : document.createElement(d, f.is && f), n = null, l = !1;
  }
  if (d === null)
    M === f || l && e.data === f || (e.data = f);
  else {
    if (n = n && H.call(e.childNodes), g = (M = i.props || k).dangerouslySetInnerHTML, o = f.dangerouslySetInnerHTML, !l) {
      if (n != null)
    ...
    if (Qe(e, f, M, c, l), o)
      t.__k = [];
    else if (Le(e, ee(h = t.props.children) ? h : [h], t, i, s, c && d !== "foreignObject", n, r, n ? n[0] : i.__k && Z(i, 0), l, u), n != null)
      for (h = n.length; h--; )
        n[h] != null && xe(n[h]);
    l || ("value" in f && (h = f.value) !== void 0 && (h !== e.value || d === "progress" && !h || d === "option" && h !== M.value) && G(e, "value", h, M.value, !1), "checked" in f && (h = f.checked) !== void 0 && h !== e.checked && G(e, "checked", h, M.checked, !1));
  }
  return e;
}
function ie(e, t, i) {
...
function Ce(e, t, i) {
  var s, c;
  if (p.unmount && p.unmount(e), (s = e.ref) && (s.current && s.current !== e.__e || ie(s, null, t)), (s = e.__c) != null) {
  ...
  if (s = e.__k)
    for (c = 0; c < s.length; c++)
      s[c] && Ce(s[c], t, i || typeof e.type != "function");
  i || e.__e == null || xe(e.__e), e.__ = e.__e = e.__d = void 0;
}
function He(e, t, i) {
...
function Je(e, t, i) {
  var s, c, n, r;
  p.__ && p.__(e, t), c = (s = typeof i == "function") ? null : i && i.__k || t.__k, n = [], r = [], te(t, e = (!s && i || t).__k = Fe(C, null, [e]), c || k, k, t.ownerSVGElement !== void 0, !s && i ? [i] : c ? null : t.firstChild ? H.call(t.childNodes) : null, n, !s && i ? i : c ? c.__e : t.firstChild, s, r), Ne(n, e, r);
}
H = Ie.slice, p = { __e: function(e, t, i, s) {
  for (var c, n, r; t = t.__; )
    if ((c = t.__c) && !c.__)
      try {
        if ((n = c.constructor) && n.getDerivedStateFromError != null && (c.setState(n.getDerivedStateFromError(e)), r = c.__d), c.componentDidCatch != null && (c.componentDidCatch(e, s || {}), r = c.__d), r)
          return c.__E = c;
      } catch (l) {
        e = l;
      }
  throw e;
} }, we = 0, z.prototype.setState = function(e, t) {
  var i;
  i = this.__s != null && this.__s !== this.state ? this.__s : this.__s = j({}, this.state), typeof e == "function" && (e = e(j({}, i), this.props)), e && j(i, e), e != null && this.__v && (t && this._sb.push(t), se(this));
}, z.prototype.forceUpdate = function(e) {
  this.__v && (this.__e = !0, e && this.__h.push(e), se(this));
}, z.prototype.render = C, T = [], me = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, X = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, Q.__r = 0;
var Re = 0;
function a(e, t, i, s, c, n) {
  var r, l, u = {};
  for (l in t)
    l == "ref" ? r = t[l] : u[l] = t[l];
  var w = { type: e, props: u, key: i, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: --Re, __source: c, __self: n };
  if (typeof e == "function" && (r = e.defaultProps))
    for (l in r)
      u[l] === void 0 && (u[l] = r[l]);
  return p.vnode && p.vnode(w), w;
}
const Ke = "https://www.nsf.gov/awardsearch/showAward", B = ({
  number: e
}) => a("a", {
  href: `${Ke}?AWD_ID=${e}&HistoricalAwards=false`,
  children: ["#", e]
}), O = ({
  className: e = null,
  items: t
...
var V, x, K, re, _ = 0, je = [], W = [], ue = p.__b, de = p.__r, pe = p.diffed, ge = p.__c, he = p.unmount;
function oe(e, t) {
  p.__h && p.__h(x, e, _ || t), _ = 0;
  var i = x.__H || (x.__H = { __: [], __h: [] });
  return e >= i.__.length && i.__.push({ __V: W }), i.__[e];
}
function J(e) {
  return _ = 1, $e(Se, e);
}
function $e(e, t, i) {
  ...
  if (s.t = e, !s.__c && (s.__ = [i ? i(t) : Se(void 0, t), function(l) {
    ...
    x.componentWillUpdate = function(l, u, w) {
      if (this.__e) {
        var g = n;
        n = void 0, c(l, u, w), n = g;
      }
      r && r.call(this, l, u, w);
    }, x.shouldComponentUpdate = c;
  }
  return s.__N || s.__;
}
function R(e, t) {
  var i = oe(V++, 3);
  !p.__s && ot(i.__H, t) && (i.__ = e, i.i = t, x.__H.__h.push(i));
}
function et() {
  var e = oe(V++, 11);
  if (!e.__) {
...
function tt() {
  for (var e; e = je.shift(); )
    if (e.__P && e.__H)
      try {
        e.__H.__h.forEach(F), e.__H.__h.forEach(q), e.__H.__h = [];
      } catch (t) {
...
p.__b = function(e) {
  ...
  de && de(e), V = 0;
  var t = (x = e.__c).__H;
  t && (K === x ? (t.__h = [], x.__h = [], t.__.forEach(function(i) {
    i.__N && (i.__ = i.__N), i.__V = W, i.__N = i.i = void 0;
  })) : (t.__h.forEach(F), t.__h.forEach(q), t.__h = [], V = 0)), K = x;
}, p.diffed = function(e) {
  pe && pe(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (je.push(t) !== 1 && re === p.requestAnimationFrame || ((re = p.requestAnimationFrame) || it)(tt)), t.__H.__.forEach(function(i) {
    i.i && (i.__H = i.i), i.__V !== W && (i.__ = i.__V), i.i = void 0, i.__V = W;
  })), K = x = null;
}, p.__c = function(e, t) {
  t.some(function(i) {
    try {
      i.__h.forEach(F), i.__h = i.__h.filter(function(s) {
        return !s.__ || q(s);
      });
    } catch (s) {
      t.some(function(c) {
...
function it(e) {
  var t, i = function() {
    clearTimeout(s), Me && cancelAnimationFrame(t), setTimeout(e);
  }, s = setTimeout(i, 100);
  Me && (t = requestAnimationFrame(i));
}
function F(e) {
  var t = x, i = e.__c;
...
const $ = (e = 900) => document.body.clientWidth >= e ? "desktop" : "mobile", De = (e = 900) => {
  const [t, i] = J($(e));
  return R(() => {
    window.addEventListener("resize", () => i($(e)));
  }, []), t;
}, E = (e, t) => {
  ...
  Je(e, i);
}, Te = () => window.pageYOffset !== void 0 ? window.pageYOffset : (document.documentElement || document.body.parentNode || document.body).scrollTop, nt = ({
  showAfterScroll: e = 300
}) => {
  const [t, i] = J(!1);
  return R(() => {
    window.addEventListener("scroll", () => i(Te() >= e));
  }, []), a("button", {
  ...
  children: [a("div", {
    ...
    children: [a("div", {
      ...
      children: [a("div", {
        ...
        children: [a("p", {
          class: "awards",
          children: ["ACCESS is an advanced computing and data resource program supported by the U.S. National Science Foundation (NSF) under the Office of Advanced Cyberinfrastructure awards", " ", a(B, {
            number: 2138259
          }), ", ", a(B, {
            number: 2138286
          }), ",", " ", a(B, {
...
}), ct = `.container{box-sizing:content-box;height:84px;padding-top:20px}@media (min-width: 900px){.container{height:146px;padding-top:52px}}
`, at = (e = {}) => a(C, {
  children: [a("div", {
    class: "container",
    children: a(be, {
...
`, Ee = ({
  ...
  const g = et(), o = l[u] == g, M = o || e == n, f = () => w({
    ...l,
    [u]: o ? null : g
  });
  if (s)
  ...
  const c = De(1280), [n, r] = J({});
  return R(() => {
    document.body.addEventListener("click", (l) => {
      l.target != s && $() == "desktop" && r({});
...
`, ut = ({
  ...
  if (e.forEach((l) => {
    ...
    r.length && window.addEventListener("scroll", function() {
      const l = Te() + window.innerHeight * 0.1;
      let u = -1;
      r.forEach((w, g) => {
        if (w.offsetTop < l)
          return u = g, !1;
  ...
  if (t === void 0 && (t = document.cookie.split("; ").includes("SESSaccesscisso=1")), e === void 0) {
    ...
    })), e = [...Ve, r], c && (e.find((l) => l.name == c).classes += " active");
  }
  E(a(Be, {
    classes: "universal",
    items: e,
...
export {
  ...
  pt as header,
  Ye as loginMenuItem,
  Pe as myAccessMenuItem,
  ht as siteMenus,
  ft as tableOfContents,
  Ve as universalMenuItems,
  gt as universalMenus
};
